...
- 2 years as a Product Developer in food production
- Currently part-time to focus on the career change

## Roadmap

### Months 1-3: Foundations
- [x] Python for Data Science, AI & Development (IBM)
- [ ] Mathematics for Machine Learning (IBM)
...
notebooks, and exercises inside.
